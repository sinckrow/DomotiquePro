...
public class ActivityListLog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            //Demande et ajout des permissions de lecture des SMS
            if (ContextCompat.checkSelfPermission(ActivityListLog.this, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale(ActivityListLog.this, Manifest.permission.READ_SMS)) {
                    ActivityCompat.requestPermissions(ActivityListLog.this, new String[]{Manifest.permission.READ_SMS}, 1);
                }
            }
